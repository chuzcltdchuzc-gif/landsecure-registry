...
const roleMenus = {
  general_user: [
    ...
    { label: "Surveyor Network", icon: Database, path: "/lv/surveyor-network" },
  ...
  surveyor_general: [
    ...
    { label: "Surveyor Network", icon: Database, path: "/lv/surveyor-network" },
    { label: "Archive Import", icon: Database, path: "/lv/archive-import" },
  ...
  licensed_surveyor: [
    ...
    { label: "Import Archives", icon: Database, path: "/lv/archive-import" },
    { label: "Parcel Registry", icon: MapPin, path: "/lv/parcels" },
    { label: "Verify Parcel", icon: Search, path: "/lv/verify" },
    { label: "Surveyor Network", icon: Database, path: "/lv/surveyor-network" },
    { label: "Notifications", icon: Bell, path: "/notifications" },
  ...
  surveyor_partner: [
    ...
    { label: "Import Archives", icon: Database, path: "/lv/archive-import" },
    { label: "My Archives", icon: Database, path: "/lv/surveyor" },
    { label: "Parcel Registry", icon: MapPin, path: "/lv/parcels" },
    { label: "Duplicate Alerts", icon: AlertTriangle, path: "/lv/duplicates" },
    { label: "Verify Parcel", icon: Search, path: "/lv/verify" },
    { label: "Notifications", icon: Bell, path: "/notifications" },
